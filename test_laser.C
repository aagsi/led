...
void test_laser(TString infile="../build/20m_20_laser_25_1_4.root", Int_t ID= -99, TString out_file= "out.root"){ 
					...
					do{
						...
						if(true){ 
							if(r<=val){
								...
								hPTime[mcpid][pixid]->Fill(evtime+tr); // add tr
							}
